...
export function PublicListingCard({ listing }: PublicListingCardProps) {
  ...
  return (
    <Card className="group h-full overflow-hidden rounded-[1.85rem] border-[#d8e3d8] bg-white transition duration-200 hover:-translate-y-1 hover:border-primary/35 hover:shadow-[0_26px_60px_-36px_rgba(19,33,23,0.35)]">
      <div className="relative aspect-[16/10] overflow-hidden bg-[linear-gradient(160deg,#edf4ee_0%,#e0ebe1_100%)]">
        {coverImage ? (
          <img
            alt={listing.title}
