...
export function ListingSidebarCard({ children, title }: ListingSidebarCardProps) {
  return (
    <Card className="overflow-hidden rounded-[1.85rem] border-0 bg-white shadow-[0_24px_56px_-44px_rgba(19,33,23,0.28)]">
      <CardHeader className="bg-[linear-gradient(180deg,#fafcf9_0%,#f4f8f3_100%)] pb-4">
